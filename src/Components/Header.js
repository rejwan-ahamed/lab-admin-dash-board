      ...
      <div className="mobile-nav-main block sm:hidden">
        ...
        {open ? (
          <div
            ...
            className="z-[100] duration-500 fixed main-mobile-nav-section bg-gray-50 h-screen w-full flex flex-col gap-3  font-general font-[500] text-2xl text-left pt-10 dark:bg-black dark:text-white"
          >
            ...
            <Link className="absolute bottom-[10%] text-white pt-2 px-6 py-1 pb-2 bg-red-600 max-w-max rounded-full ml-4 leading-none text-[18px] duration-300 border border-red-600 hover:bg-transparent hover:border-red-600 hover:text-red-600 dark:border-[#EBFF00] dark:bg-[#eaff006d] dark:text-[#EBFF00]">
              Logout
            </Link>

            <div className="button-toggle-group dark:text-black absolute bottom-16 right-0 mr-4">
              {theme === "dark" ? (
                <button
                  onClick={() => handelTheme()}
