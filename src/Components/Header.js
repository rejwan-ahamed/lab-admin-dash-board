    ...
    <>
      ...
      <div className="header-holder border-b hidden sm:block">
        <Navbar
          fluid={true}
          rounded={true}
          className=" xl:px-40 font-general max-w-[1560px] mx-auto rounded-none duration-500 bg-white dark:bg-black  dark:text-white"
        >
          ...
          <Navbar.Collapse className="flex flex-row max-h-max items-center">
            ...
            <div className="darkMode-button-group cursor-pointer">
              <div
                onClick={() => handelTheme()}
                className="dark-mode bg-violet-50 p-2 rounded-full border border-violet-500 dark:border-[#ebff00] dark:text-black"
              >
                {theme === "dark" ? (
                  <svg
      ...
      <div className="mobile-nav-main block sm:hidden">
        ...
        {open ? (
          <div
            ...
            className="z-[100] duration-500 fixed main-mobile-nav-section bg-gray-50 h-screen w-full flex flex-col gap-3  font-general font-[500] text-2xl text-left pt-10"
          >
